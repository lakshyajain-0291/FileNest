...
func main() {
    ...
    if *store {
        handleStore(kademliaHandler, selfNodeID)
    }
...
func handleStore(kademliaHandler *integration.ComprehensiveKademliaHandler, selfNodeID []byte) {
    log.Println("💾 Storing test embeddings...")
