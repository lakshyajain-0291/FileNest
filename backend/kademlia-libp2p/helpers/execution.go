...
// Peer authorization and rate limiting
...
func checkRateLimit(peerID peer.ID) bool {
	...
	return requestCount <= 100 // Max 100 requests per peer
}
...
func handleTargetNodeExecution(dbService *DatabaseService, request EmbeddingSearchRequest,
	...
	if currentDepth < 4 {
		...
		// Process embedding and update centroid
		...
		// Send response with host peer ID
...
// GetHostPeerID returns the stored host peer ID
